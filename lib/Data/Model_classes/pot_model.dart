...
//       plantType: map['plantType'] as int,
//       plantName: map['plantName'] as String,
//       plantImage: map['plantImage'] as String,
//       wateringIntervalDays: map['wateringIntervalDays'] as int,
//       daysMask: map['daysMask'] as int,
//       timeMinutes: map['timeMinutes'] as int,
//       wateringsPerDay: map['wateringsPerDay'] as int,
//       waterDuration: map['waterDuration'] as int,
//       batteryLevel: map['batteryLevel'] as int,
//       tankStatus: map['tankStatus'] as int,
//       lastWatered: map['lastWatered'] as int,
//       cycleCount: map['cycleCount'] as int,
//       lowBattery: map['lowBattery'] as bool,
//       firmwareVersion: map['firmwareVersion'] as String,
//       pairedAt: map['pairedAt'] as int,
...
//       wateringsPerDay: wateringsPerDay ?? this.wateringsPerDay,
//       waterDuration: waterDuration ?? this.waterDuration,
